...
function(ryppl_export)
  ...
  if(RYPPL_PROJECT_DUMP_DIRECTORY)
    ...
    get_property(find_package_args_direct DIRECTORY PROPERTY RYPPL_FIND_PACKAGE_ARGS)
    foreach(find_package ${find_package_args})
      list(FIND find_package_args_direct "${find_package}" index)
      if("${index}" GREATER "-1")
        ryppl_xml_append_list(xml "  " find-package arg "${find_package}")
      else()
        ryppl_xml_append_list(xml "  " find-package-indirect arg "${find_package}")
      endif()
    endforeach()
